...
function HomeFiber() {
	return (
		<div className="morph" 	>
			<h1 className="info" style={{color:'grey'}}>ModulusPI</h1>
			<Canvas
				shadowMap
				gl={{ alpha: false, antialias: false }}
				camera={{ fov: 75, position: [0, 0, 70], near: 10, far: 250 }}
				onCreated={(state) => state.gl.setClearColor('#6200EA')}
